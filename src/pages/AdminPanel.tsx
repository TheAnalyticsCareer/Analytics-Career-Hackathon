...
const AdminPanel: React.FC = () => {
  ...
  // Google Form link for all submissions
  const submissionsFormUrl = 'https://docs.google.com/forms/d/1KP_e3yl0T99cCfMCzxhY101txCypig_tJpA0gvJzXLg/edit#responses'; // TODO: Replace with actual form link
          ...
          <div className="p-4 sm:p-6">
            ...
            {activeTab === 'submissions' && (
              <div className="flex flex-col items-center justify-center py-8">
                <a
                  href={submissionsFormUrl}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-block px-6 py-3 mb-6 bg-blue-600 text-white font-semibold rounded-lg shadow hover:bg-blue-700 transition-colors duration-200"
                >
